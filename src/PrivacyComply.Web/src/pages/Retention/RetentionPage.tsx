...
function RetentionPage() {
    ...
    useEffect(() => {
        async function loadRetentionData() {
            try {
                const [policyResult, coverageResult] = await Promise.all([
                    getRetentionPolicies(),
                    getRetentionCoverage(),
                ])
        ...
        <section className="retention-page">
            <header className="retention-page__header">
                ...
                <p className="retention-page__description">
                    Manage retention policies, review coverage, evaluate retention
                    obligations, and track retention-related compliance activity.
                </p>
            </header>
            ...
            <section className="retention-page__panel">
                ...
                {!isLoading && !errorMessage && policies.length === 0 && (
                    <p className="retention-page__panel-description">
                        ...
                        {policies.map((policy) => (
                            ...
                            >
                                ...
                                <div className="retention-page__policy-details">
                                    ...
                                    <span className="retention-page__policy-detail">
                                        Trigger: {policy.retentionTriggerCode}
                                    </span>

                                    <span className="retention-page__policy-detail">
                                        Expiry: {policy.expiryActionCode}
                                    </span>
            ...
            {!isLoading && !errorMessage && (
                <section className="retention-page__panel">
                    ...
                    {coverage.length === 0 && (
                        <p className="retention-page__panel-description">
                            No processing activities are currently available for retention
                            coverage review.
                        </p>
                    )}
